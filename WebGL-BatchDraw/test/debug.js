function main() {
    ...
    if (batchDrawer.error != null) {
		...
		for (var x = deta; x < 1; x+=deta) {
			//console.log(x, x+deta)
			batchDrawer.addLine(x, 0.5, x+deta, 0.5, 0.01, 0.8, 0.1, 0.7, 0.5);
		}
		
		//batchDrawer.addLine(0.1, 0.5, 0.2, 0.5, 0.01, 0.8, 0.1, 0.7, 0.5);
		//batchDrawer.addLine(0.2, 0.5, 0.3, 0.5, 0.01, 0.8, 0.1, 0.7, 0.5);

        // In normalized screen coordinates [0, 1]
        //batchDrawer.addLine(0.01, 0.5, 0.02, 0.5, 0.01, 0.8, 0.1, 0.7, 0.5);
